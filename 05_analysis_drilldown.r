...
WordAnalysis<-function(df){
        ...
        docs <- Corpus(VectorSource(dfs_positive$cust_review))
        ...
        docs<-tm_map(docs, removeWords, c("pizza","hut","pizzahut","pizzas","also","one","went","london"))
        ...
        wordcloud(names(freq), freq, min.freq=3,colors=brewer.pal(6, "Dark2"),
